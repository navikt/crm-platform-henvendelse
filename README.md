...
The frontend functionality is delivered by a set og LWC that can be exposed [externally](force-app/main/default/core-functionality/external-components/) and [internally](force-app/main/default/core-functionality/internal-components/)
